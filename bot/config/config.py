...
class Settings(BaseSettings):
    ...
    TASKLIST_CD_1: list[object] = [{"task_id": 2001, "compeleteCount": 2, "cd": 120},
                                 {"task_id": 2002, "compeleteCount": 8, "cd": 2},
                                 {"task_id": 2003, "compeleteCount": 6, "cd": 2},
                                 {"task_id": 2004, "compeleteCount": 5, "cd": 5},
                                 {"task_id": 2005, "compeleteCount": 3, "cd": 10}]
    USE_REF: bool = False
    REF_ID: str = ''
